...
namesummary=brighter_wkk_wt
nameplot=brighter_wkk_wt
...
for SampleName in WKK.his_1 WKK.his_2 WT.his_1 WT.his_2 HBD.his_1 HBD.his_2 \
HBD.igg_1 HBD.igg_2; do
bam=$projPathC/alignment/bam/$SampleName.mapped.sorted.filtered.bam
bamfiles+=" $bam"
done

samples=("WKK_His_1" "WKK_his_2" "WT_His_1" "WT_His_2" \

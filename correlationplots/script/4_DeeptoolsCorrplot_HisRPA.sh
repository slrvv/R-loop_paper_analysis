...
# purpose: correlation plot His and RPA                                        #
################################################################################

#-----------------------------Paths--------------------------------------------#

projPathC=/project/ChromGroup_Seq_data/Celeste/2024_summer_complete
projPathnew=/project/ChromGroup_Seq_data/Celeste/2025_02
experimentSummaryC=$projPathC/experiment_summary_align_formatted.csv
namesummary=hbd_wt_wkk_rpa_experiments_bam_Celeste
nameplot=hbd_wt_wkk_rpa_experiments_corr_heatmap_Celeste
...
bamfiles=()
samples=()
for SampleName in HBD.his_1 HBD.his_2 WKK.his_1 WKK.his_2  WT.his_1 WT.his_2 \
HBD.rpa70_1 HBD.rpa70_2 WT.rpa70_1 WT.rpa70_2 \

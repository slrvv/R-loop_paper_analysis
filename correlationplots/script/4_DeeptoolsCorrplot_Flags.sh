...
namesummary=flag_experiments_bam_Celeste_Serkan
nameplot=flag_experiments_corr_heatmap_Celeste_Serkan
...
bamfiles=()
samples=()
for SampleName in HBD.flag_1 HBD.flag_2 HBD.igg_1 HBD.igg_2
do
...
for SampleName in Flag.mo_1 Flag.mo_2 Flag.rab_1 Flag.rab_2
do
